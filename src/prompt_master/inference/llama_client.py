...
class LlamaClient:
    ...
    def stream_chat(self, messages: list[dict], max_tokens: int, seed: int, on_text: Callable[[str], None], cancel: threading.Event | None = None) -> str:
        payload = {"model":"prompt-master","messages":messages,"temperature":0.85,"top_p":0.95,"max_tokens":max_tokens,"seed":seed,"stream":True,"reasoning_effort":"none","chat_template_kwargs":{"enable_thinking":False,"thinking":False}}
        pieces = []
